"""Data models for state machine testing and path tracking.

This module provides dataclasses for recording transition executions,
coverage metrics, deficiencies, and path histories during state machine

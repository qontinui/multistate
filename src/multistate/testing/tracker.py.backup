...
class PathTracker:
    ...
    def __init__(
        ...
        self.enable_screenshots = enable_screenshots and HAS_CV2
        ...
        if enable_screenshots and not HAS_CV2:
            logger.warning(
    ...
    def _save_screenshot(self, execution_id: str, screenshot: Any) -> str | None:
        ...
        if not HAS_CV2:
            logger.warning(
                "Cannot save screenshot: opencv-python not available. "
                "Install with: pip install multistate[testing]"
            )
            return None

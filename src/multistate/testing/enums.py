"""Enumerations for state machine testing and path tracking.

This module provides status and classification enums for tracking
transition executions and identifying deficiencies during state
machine testing and exploration.
"""
